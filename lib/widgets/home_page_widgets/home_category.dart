...
import 'package:covidtracker/screens/Vaccine.dart';
import 'package:covidtracker/screens/twitter/twitter_screen.dart';
...
class CategoryTab extends StatelessWidget {
  ...
  Function getPage(tabName, context) {
    switch (tabName) {
      ...
      case ("Resources"):
        return () => Navigator.of(context)
            .push(MaterialPageRoute(builder: (context) => TwitterScreen()));
    }
    return () {};
  }
